...
namespace QuanLyBanBida
{
    ...
    {
        private string connect = "Data Source=DESKTOP-N764A3I\\SQLEXPRESS;Initial Catalog=QuanLyQuanBiDaFinal1;Integrated Security=True";
        ...
        public void addTable(string name, string status)
        {
            ...
            else
            {
                ...
                cmd.Parameters.AddWithValue("@status", status);// nhập dữ liệu
                sqlConnection.Open();
                cmd.ExecuteNonQuery();
                sqlConnection.Close();
        ...
        private void cb_TableStatus_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void btn_DeleteTable_Click_1(object sender, EventArgs e)
        {
        ...
        private void btn_NextCategory_Click_1(object sender, EventArgs e)
        {
        ...
        private void btn_PrevioursCategory_Click_1(object sender, EventArgs e)
        {
            if (bs.Position > 0)
            {
                bs.Position--;
        ...
        private void btn_LastCategory_Click_1(object sender, EventArgs e)
        {
            bs.Position = bs.Count - 1;
        }

        private void btn_FristCategory_Click_1(object sender, EventArgs e)
        {
            bs.Position = 0;
        }
    }
