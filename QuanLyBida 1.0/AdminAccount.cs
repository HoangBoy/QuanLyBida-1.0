...
namespace QuanLyBanBida
{
    public partial class AdminAccount : Form
    {
        ...
        public void AddAccount(string displayName, string userName, string password, string type)
        {
        ...
        public void SearchTaikhoan(string displayName)
        {
            using (SqlConnection sqlConnection = new SqlConnection(connect))
            {
                ...
                adapter.SelectCommand.Parameters.AddWithValue("@DisplayName", displayName);
        ...
        private void btn_AddAccount_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                AddAccount(displayname, username, password, type);
                viewlistaccount();
                txt_type.Text = "";
