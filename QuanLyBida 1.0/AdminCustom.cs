...
namespace QuanLyBanBida
{
    public partial class AdminCustom : Form
    {
        ...
        public void ThemKhachHang(string idCustomer, string name, string gender, string phoneNumber, string dayCheckin, string idCategoryCustomer)
        {
            using (SqlConnection conn = new SqlConnection(connect))
            {
                ...
                {
                    if (ex.Number == 2627) // Mã lỗi 2627 là lỗi Unique Key Violation
                    {
        ...
        private void btn_AddCustomer_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ThemKhachHang(idcustomer, name, gender, phonenumber, daycheckin, idcatgorycustomer);
                xemdulieukhachang();
                txt_IDCustomer.Text = "";
        ...
        private void txt_CategoryCustomer_TextChanged(object sender, EventArgs e)
        {

        }

        private void txt_SexCustomer_TextChanged(object sender, EventArgs e)
        {
